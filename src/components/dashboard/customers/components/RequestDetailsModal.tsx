  ...
  const loadRequestDetails = async () => {
    ...
    try {
      const response = await fetch(
        `/api/customers/${customer.id}/requests${requestId ? `?requestId=${requestId}` : ''}`
      );
              ...
              <div className="space-y-2 max-h-96 overflow-y-auto">
                {requests.map(request => (
                  ...
                  >
                    ...
                    <div
                      className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium border ${getStatusColorClasses(request.status)}`}
                    >
                      <span>{request.status}</span>
                    </div>
                    {request.sentAt && (
                      <p className="text-xs text-gray-500 mt-1">{formatDate(request.sentAt)}</p>
                    )}
                  </button>
                ))}
              </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white border border-gray-200 rounded-lg p-4">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div
                        className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium border ${getStatusColorClasses(selectedRequest.status)}`}
                      >
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="bg-gray-50 p-3 rounded-lg text-center">
                          ...
                          <p className="text-lg font-bold text-gray-900">
                            {selectedRequest.sentAt
                              ? formatDate(selectedRequest.sentAt)
                              : 'Not sent'}
                          </p>
                        </div>
                        <div className="bg-green-50 p-3 rounded-lg text-center">
                          ...
                          <p className="text-lg font-bold text-green-900">
                            {selectedRequest.deliveredAt
                              ? formatDate(selectedRequest.deliveredAt)
                              : 'Pending'}
                          </p>
                        </div>
                        <div className="bg-blue-50 p-3 rounded-lg text-center">
                          ...
                          <p className="text-lg font-bold text-blue-900">
                            {selectedRequest.clickedAt
                              ? formatDate(selectedRequest.clickedAt)
                              : 'Not clicked'}
                          </p>
                        </div>
                          ...
                          <div className="space-y-2 text-sm">
                            <div>
                              ...
                              <span className="ml-2 font-medium">
                                {selectedRequest.metadata.businessInfo.name}
                              </span>
                            </div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          {selectedRequest.metadata.clickCount !== undefined && (
                            <div>
                              ...
                              <span className="ml-2 font-medium">
                                {selectedRequest.metadata.clickCount}
                              </span>
                            </div>
                          )}
                        </div>
