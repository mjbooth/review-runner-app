...
import { Tag, Plus, X, Save, Hash, User } from '@/components/ui/icons';
...
export function CustomerTagsModal({ isOpen, onClose, customer, onSave }: CustomerTagsModalProps) {
  ...
  const getTagColorClasses = (color: string) => {
    ...
    return colorConfig
      ? { bg: colorConfig.bg, text: colorConfig.text }
      : { bg: 'bg-gray-100', text: 'text-charcoal' };
  };
