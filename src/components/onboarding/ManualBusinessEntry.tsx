...
import { Building2, MapPin, Phone, Globe, Check, X, AlertCircle } from '@/components/ui/icons';
import { type BusinessData } from './BusinessPreviewCard';
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                ...
                hasError('name') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white'
              )}
          ...
          <div className="relative">
            ...
            <textarea
              ...
              className={cn(
                ...
                hasError('address') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white'
              )}
        ...
        <div>
          <label
            htmlFor="manual-business-website"
            className="block text-sm font-semibold text-charcoal mb-2"
          >
          ...
          <div className="relative">
            ...
            <input
              ...
              className={cn(
                'w-full pl-10 pr-4 py-3 border rounded-lg text-base transition-colors focus:outline-none focus:ring-2 focus:ring-forgedorange-500 focus:border-transparent',
                hasError('website') ? 'border-red-300 bg-red-50' : 'border-gray-300 bg-white'
              )}
  ...
  return (
    <div className={cn('text-center p-4', className)}>
      <div className="bg-gray-50 rounded-lg p-6 space-y-3">
        ...
        <div>
          <h4 className="text-sm font-medium text-gray-900 mb-1">Can't find your business?</h4>
